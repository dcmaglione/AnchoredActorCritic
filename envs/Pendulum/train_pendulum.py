...
def parse_args_and_train(args=None):
    ...
    hp = HyperParams(epochs=cmd_args.epochs, q_lr=cmd_args.learning_rate, pi_lr=cmd_args.learning_rate, seed=cmd_args.seed, start_steps=cmd_args.start_steps, act_noise=cmd_args.act_noise, max_ep_len=200, q_importance=2.0)
