...
def parse_args(args=None):
    ...
    parser.add_argument('-g', '--gravity', type=float, default=-10.0, help="gravity")
    parser.add_argument('-i', '--initial-random', type=float, default=1000.0, help="initial random velocity")
...
if __name__ == "__main__":
    ...
    cmd_args = parse_args()
    test_utils.run_tests(LunarLander(enable_wind=cmd_args.wind, gravity=cmd_args.gravity, initial_random=cmd_args.initial_random, render_mode="human" if cmd_args.render else None), cmd_args)
